...
class Cotizacion():
    ...
    def Export_to_CSV(self, other):
        ...
        self.comparative_table[f'{gv.TABLE_WITH_BEST_PRICES}'] = pd.Series(self.table_with_best_prices).fillna(0)
        ...
        while True:
            try:
                self.comparative_table.to_csv(filepath, index=None, header=True, encoding='utf-8-sig')
                break
